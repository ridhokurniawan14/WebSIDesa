...
@section('content')
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400 mt-2 text-sm">
                    Buat prosedur dan persyaratan layanan desa baru.
                </p>
            </div>
    ...
    <div
        ...
        <form action="{{ route('admin.administrasi.store') }}" method="POST" class="p-8" autocomplete="off">
            @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama') }}" required
                            placeholder="Contoh: Pembuatan KTP Elektronik"
                        ...
                        <div class="relative">
                            <select name="kategori" required
                                ...
                                <option value="surat-keterangan"
                                    {{ old('kategori') == 'surat-keterangan' ? 'selected' : '' }}>Surat Keterangan</option>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Deskripsi
                            Singkat</label>
                        <textarea name="deskripsi" rows="4" placeholder="Jelaskan secara singkat kegunaan layanan ini..."
                            class="w-full rounded-xl border-gray-300 dark:bg-gray-700 dark:border-gray-600 focus:ring-indigo-500 focus:border-indigo-500 p-4 shadow-sm hover:border-indigo-400 transition-all resize-none">{{ old('deskripsi') }}</textarea>
                    </div>
                </div>
