...
<<<<<<< HEAD
            ...
            'url' => 'admin/profil',
=======
            'icon' => 'M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75m-.75 3h.75m-.75 3h.75m-.75 3h.75m-.75 3h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z',
            'url' => 'admin/profil', 
>>>>>>> 7e29c69c824bc17b9384ffe6ed52c46ea84d74fb
            'submenu' => [
...
=======
            ...
            <div class="relative group"
                 x-data="{ top: 0 }"
                 @mouseenter="top = $el.getBoundingClientRect().top">
...
=======
                ...
                {{-- 
                    ...
                    - Posisi dimajukan ke dalam sidebar (left-[60px])
                    - Padding diperbesar (pl-8) agar area hover nyambung dan overlap dengan icon
                --}}
                <div x-show="!sidebarOpen"
                     class="fixed left-[60px] pl-8 z-[9999] pointer-events-none hidden"
                     :class="!sidebarOpen ? 'group-hover:block' : ''"
                     :style="'top: ' + (top + 10) + 'px'">
...
=======
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
                        ...
                        :class="activeAccordion === '{{ $menu['url'] }}' ? 'rotate-180' : ''"
>>>>>>> 7e29c69c824bc17b9384ffe6ed52c46ea84d74fb
                        x-show="sidebarOpen">
...
=======
                {{-- Mode 1: Accordion --}}
                <div x-show="sidebarOpen && activeAccordion === '{{ $menu['url'] }}'" x-collapse class="space-y-1 mt-1">
>>>>>>> 7e29c69c824bc17b9384ffe6ed52c46ea84d74fb
                    @foreach ($menu['submenu'] as $sub)
...
=======
                {{-- 
                    ...
                    - Posisi dimajukan ke dalam sidebar (left-[60px])
                    - Padding diperbesar (pl-8)
                    - Ini menciptakan overlap 20px (80-60) + area hover yang solid
                --}}
                <div x-show="!sidebarOpen"
                     class="fixed left-[60px] w-auto pl-8 z-[9999] hidden"
                     :class="!sidebarOpen ? 'group-hover:block' : ''"
                     :style="'top: ' + top + 'px'">
                     
                     <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-100 dark:border-gray-700 py-1 w-48">
                         <div class="px-4 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-gray-700 mb-1">
                            {{ $menu['label'] }}
                         </div>
