...
@foreach ($menus as $menu)
    <a href="{{ $menu['url'] }}"
        class="flex items-center gap-3 px-3 py-3 rounded-lg transition-colors group
                   {{ $menu['active'] ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-emerald-600 dark:hover:text-emerald-400' }}">
