    ...
    $menus = [
        ...
        [
            ...
            'submenu' => [
                ...
                ['label' => 'BUMDes', 'url' => 'admin/lembaga/bumdes', 'permission' => 'bumdes.view'],
                [
                    'label' => 'Karang Taruna',
                    'url' => 'admin/lembaga/karang-taruna',
                    'permission' => 'karang-taruna.view',
                ],
                ['label' => 'Koperasi Desa', 'url' => 'admin/lembaga/koperasi', 'permission' => 'koperasi.view'],
            ],
        ],
        [
            'label' => 'Transparansi',
            ...
            'permission' => 'transparansi.view',
            'submenu' => [
                ['label' => 'APBDes', 'url' => 'admin/transparansi/apbdes', 'permission' => 'apbdes.view'],
                [
                    'label' => 'Pembangunan',
                    'url' => 'admin/transparansi/pembangunan',
                    'permission' => 'pembangunan.view',
                ],
            ],
        ],
        [
        ...
        [
            'label' => 'Pesan',
            'icon' =>
                'M2.25 4.5a2.25 2.25 0 012.25-2.25h15a2.25 2.25 0 012.25 2.25v9a2.25 2.25 0 01-2.25 2.25H6.75L3 18.75V4.5z',
            'url' => 'admin/pesan',
            'permission' => 'pesan.view',
            'submenu' => [],
        ],
        [
            'label' => 'Setting',
            ...
            'submenu' => [
                ['label' => 'Aplikasi', 'url' => 'admin/setting/aplikasi', 'permission' => 'aplikasi.view'],
                ['label' => 'User', 'url' => 'admin/setting/user', 'permission' => 'user.view'],
                ['label' => 'Roles', 'url' => 'admin/setting/roles', 'permission' => 'roles.view'],
                ['label' => 'Permissions', 'url' => 'admin/setting/permissions', 'permission' => 'permissions.view'],
            ],
        ],
        [
            'label' => 'Log Activity',
